// elm-watch hot {"version":"1.1.0","targetName":"main","webSocketPort":61390}
"use strict";
(() => {
...
var $author$project$InteropDefinitions$Alert = function (a) {
	return {$: 'Alert', a: a};
};
...
var $author$project$Main$WithInvalidFlags = function (a) {
	return {$: 'WithInvalidFlags', a: a};
};
var $author$project$Main$WithValidFlags = function (a) {
	return {$: 'WithValidFlags', a: a};
};
...
var $author$project$InteropDefinitions$flags = A2(
	...
	A2($dillonkearns$elm_ts_json$TsJson$Decode$optionalNullableField, 'privateKey', $dillonkearns$elm_ts_json$TsJson$Decode$string));
...
var $dillonkearns$elm_ts_json$TsJson$Encode$value = A2($dillonkearns$elm_ts_json$TsJson$Internal$Encode$Encoder, $elm$core$Basics$identity, $dillonkearns$elm_ts_json$Internal$TsJsonType$Unknown);
		...
		$dillonkearns$elm_ts_json$TsJson$Encode$object(
			_List_fromArray(
				[
					...
					$dillonkearns$elm_ts_json$TsJson$Encode$value)
				])),
		A3(
			$dillonkearns$elm_ts_json$TsJson$Encode$variantTagged,
			'logout',
			$dillonkearns$elm_ts_json$TsJson$Encode$object(_List_Nil),
			A3(
				$dillonkearns$elm_ts_json$TsJson$Encode$variantTagged,
				'login',
				$dillonkearns$elm_ts_json$TsJson$Encode$object(
				...
				A3(
					...
					A3(
						...
						$dillonkearns$elm_ts_json$TsJson$Encode$union(
							F6(
								function (vAlert, vScrollTo, vLogin, vLogout, vPerformEosTransaction, value) {
									switch (value.$) {
										case 'Alert':
											var string = value.a;
											return vAlert(string);
										case 'ScrollTo':
											var querySelector = value.a;
											return vScrollTo(querySelector);
										case 'Login':
											var privateKey = value.a;
											return vLogin(privateKey);
										case 'Logout':
											return vLogout(
												{});
										default:
											var encodedAction = value.a;
											return vPerformEosTransaction(encodedAction);
									}
								}))))))));
var $author$project$InteropDefinitions$Alerted = {$: 'Alerted'};
var $author$project$InteropDefinitions$LoggedIn = function (a) {
	return {$: 'LoggedIn', a: a};
};
var $author$project$InteropDefinitions$LoggedOut = {$: 'LoggedOut'};
...
var $author$project$InteropDefinitions$toElm = A2(
	...
	_List_fromArray(
		[
			_Utils_Tuple2(
			'alerted',
			$dillonkearns$elm_ts_json$TsJson$Decode$succeed($author$project$InteropDefinitions$Alerted)),
			_Utils_Tuple2(
			'loggedIn',
			A2(
				$dillonkearns$elm_ts_json$TsJson$Decode$map,
				function (privateKey) {
					return $author$project$InteropDefinitions$LoggedIn(
						{privateKey: privateKey});
				},
				A2($dillonkearns$elm_ts_json$TsJson$Decode$field, 'privateKey', $dillonkearns$elm_ts_json$TsJson$Decode$string))),
			_Utils_Tuple2(
			'loggedOut',
			$dillonkearns$elm_ts_json$TsJson$Decode$succeed($author$project$InteropDefinitions$LoggedOut))
		]));
...
var $author$project$InteropPorts$fromElm = function (value) {
	return $author$project$InteropPorts$interopFromElm(
		A2($dillonkearns$elm_ts_json$TsJson$Encode$encoder, $author$project$InteropDefinitions$interop.fromElm, value));
};
...
var $author$project$Eos$Name$DotInLastPlace = {$: 'DotInLastPlace'};
var $author$project$Eos$Name$InvalidCharacters = function (a) {
	return {$: 'InvalidCharacters', a: a};
};
var $author$project$Eos$Name$Name = function (a) {
	return {$: 'Name', a: a};
};
var $author$project$Eos$Name$TooLong = {$: 'TooLong'};
var $author$project$Eos$Name$TooShort = {$: 'TooShort'};
...
var $author$project$Eos$Name$maxLength = 12;
...
var $author$project$Eos$Name$minLength = 1;
...
var $author$project$Eos$Name$fromString = function (name) {
	var sanitizedString = $elm$core$String$toLower(
	...
	if (!_v0.b) {
		return (_Utils_cmp(
			$elm$core$String$length(sanitizedString),
			$author$project$Eos$Name$minLength) < 0) ? $elm$core$Result$Err($author$project$Eos$Name$TooShort) : ((_Utils_cmp(
			$elm$core$String$length(sanitizedString),
			$author$project$Eos$Name$maxLength) > 0) ? $elm$core$Result$Err($author$project$Eos$Name$TooLong) : (A2($elm$core$String$endsWith, '.', sanitizedString) ? $elm$core$Result$Err($author$project$Eos$Name$DotInLastPlace) : $elm$core$Result$Ok(
			$author$project$Eos$Name$Name(sanitizedString))));
	} else {
		var firstInvalidCharacter = _v0.a;
		var otherInvalidCharacters = _v0.b;
		return $elm$core$Result$Err(
			$author$project$Eos$Name$InvalidCharacters(
				_Utils_Tuple2(firstInvalidCharacter, otherInvalidCharacters)));
	}
};
...
var $author$project$Pages$Home_$init = function () {
	var eosIo = A2(
		$elm$core$Result$map,
		function (name) {
			return {
				actions: A2($elm$core$List$repeat, 4, _Utils_Tuple0),
				name: name,
				tables: A2($elm$core$List$repeat, 2, _Utils_Tuple0)
			};
		},
		$author$project$Eos$Name$fromString('eos.io'));
	var cambiatusTk = A2(
		$elm$core$Result$map,
		function (name) {
			return {
				actions: A2($elm$core$List$repeat, 12, _Utils_Tuple0),
				name: name,
				tables: A2($elm$core$List$repeat, 8, _Utils_Tuple0)
			};
		},
		$author$project$Eos$Name$fromString('cambiatus.tk'));
	var cambiatusCm = A2(
		$elm$core$Result$map,
		function (name) {
			return {
				actions: A2($elm$core$List$repeat, 16, _Utils_Tuple0),
				name: name,
				tables: A2($elm$core$List$repeat, 4, _Utils_Tuple0)
			};
		},
		$author$project$Eos$Name$fromString('cambiatus.cm'));
	var contracts = $elm_community$result_extra$Result$Extra$combine(
		_List_fromArray(
			[cambiatusCm, cambiatusTk, eosIo]));
	return _Utils_Tuple2(
		{
			contracts: A2($elm$core$Result$withDefault, _List_Nil, contracts),
			searchString: ''
		},
...
var $author$project$InteropDefinitions$Logout = {$: 'Logout'};
var $author$project$Pages$Home_$update = F2(
	function (msg, model) {
		if (msg.$ === 'ClickedLogout') {
			return _Utils_Tuple2(
				model,
				$author$project$Effect$fromCmd(
					$author$project$InteropPorts$fromElm($author$project$InteropDefinitions$Logout)));
		} else {
...
var $author$project$Pages$Home_$ClickedLogout = {$: 'ClickedLogout'};
var $author$project$Pages$Home_$EnteredSearchString = function (a) {
	return {$: 'EnteredSearchString', a: a};
};
...
var $jasonliang_dev$elm_heroicons$Heroicons$Solid$xmlns = A2(
	$elm$core$Basics$composeL,
	$elm$virtual_dom$VirtualDom$property('xmlns'),
	$elm$json$Json$Encode$string);
var $jasonliang_dev$elm_heroicons$Heroicons$Solid$magnifyingGlass = function (attrs) {
	return A2(
		$elm$svg$Svg$svg,
		A2(
			$elm$core$List$cons,
			$jasonliang_dev$elm_heroicons$Heroicons$Solid$xmlns('http://www.w3.org/2000/svg'),
			A2(
				$elm$core$List$cons,
				...
				A2(
					...
					A2(
						$elm$core$List$cons,
						A2($elm$virtual_dom$VirtualDom$attribute, 'aria-hidden', 'true'),
						attrs)))),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						$elm$svg$Svg$Attributes$d('M10.5 3.75a6.75 6.75 0 100 13.5 6.75 6.75 0 000-13.5zM2.25 10.5a8.25 8.25 0 1114.59 5.28l4.69 4.69a.75.75 0 11-1.06 1.06l-4.69-4.69A8.25 8.25 0 012.25 10.5z'),
...
var $author$project$Eos$Name$toString = function (_v0) {
	var name = _v0.a;
	return name;
};
var $elm$html$Html$Attributes$value = $elm$html$Html$Attributes$stringProperty('value');
var $elm$html$Html$a = _VirtualDom_node('a');
var $jasonliang_dev$elm_heroicons$Heroicons$Solid$chevronRight = function (attrs) {
	return A2(
		$elm$svg$Svg$svg,
		A2(
			$elm$core$List$cons,
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$fillRule('evenodd'),
						$elm$svg$Svg$Attributes$d('M16.28 11.47a.75.75 0 010 1.06l-7.5 7.5a.75.75 0 01-1.06-1.06L14.69 12 7.72 5.03a.75.75 0 011.06-1.06l7.5 7.5z'),
						$elm$svg$Svg$Attributes$clipRule('evenodd')
					]),
				_List_Nil)
			]));
};
var $author$project$Pages$Home_$viewContractCard = function (_v0) {
	var name = _v0.name;
	var actions = _v0.actions;
	var tables = _v0.tables;
	return A2(
		$elm$html$Html$a,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('flex items-center justify-between bg-white rounded shadow py-4 px-6 group')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('font-semibold leading-tight')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
								$author$project$Eos$Name$toString(name))
							])),
						A2(
						$elm$html$Html$div,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('text-gray-500 leading-tight')
							]),
						_List_fromArray(
							[
								$elm$html$Html$text(
				...
				$jasonliang_dev$elm_heroicons$Heroicons$Solid$chevronRight(
				_List_fromArray(
					[
						$elm$svg$Svg$Attributes$class('w-4 h-4 text-gray-400 group-hover:translate-x-0.5 transition-transform')
					]))
			]));
};
...
var $author$project$Ui$AutoAnimate$viewKeyed = $elm$html$Html$Keyed$node('auto-animate');
var $author$project$Pages$Home_$viewContracts = function (model) {
	return A2(
		$elm$html$Html$main_,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('h-full bg-slate-100 pt-4')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('container mx-auto px-4 flex items-center justify-between')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('placeholder:text-gray-400 bg-white border rounded py-2 pl-4 pr-10 w-80'),
										$elm$html$Html$Attributes$placeholder('Search'),
										$elm$html$Html$Attributes$value(model.searchString),
										$elm$html$Html$Events$onInput($author$project$Pages$Home_$EnteredSearchString)
									]),
								_List_Nil),
								$jasonliang_dev$elm_heroicons$Heroicons$Solid$magnifyingGlass(
								_List_fromArray(
									[
										$elm$svg$Svg$Attributes$class('text-gray-400 w-4 h-4 absolute top-1/2 -translate-y-1/2 right-4 pointer-events-none')
									]))
							]))
					])),
				A2(
				$author$project$Ui$AutoAnimate$viewKeyed,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('container mx-auto px-4 grid grid-cols-1 md:grid-cols-3 gap-4 w-full mt-4')
					]),
				A2(
					$elm$core$List$map,
					function (contract) {
						return _Utils_Tuple2(
							$author$project$Eos$Name$toString(contract.name),
							$author$project$Pages$Home_$viewContractCard(contract));
					},
					A3(
						...
						A2(
							...
							$author$project$Eos$Name$toString),
						model.searchString,
						model.contracts)))
			]));
};
...
var $author$project$Pages$Home_$viewHeader = function (_v0) {
	var logout = _v0.logout;
	return A2(
		$elm$html$Html$header,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('w-full py-2 bg-slate-700 text-white')
			]),
		_List_fromArray(
			[
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('container mx-auto px-4 flex')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$text('elm-eos')
							])),
						A2(
						$elm$html$Html$button,
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('ml-auto hover:bg-slate-100 hover:text-black transition-colors rounded px-4 py-1'),
...
var $author$project$Pages$Home_$view = F2(
	function (_v0, model) {
		return {
			body: _List_fromArray(
				[
					$author$project$Pages$Home_$viewHeader(
					{logout: $author$project$Pages$Home_$ClickedLogout}),
					$author$project$Pages$Home_$viewContracts(model)
				]),
...
var $author$project$Pages$Home_$page = F2(
	function (shared, _v0) {
		return $author$project$Page$protected.advanced(
			function (_v1) {
				return {
...
var $author$project$Pages$Login$init = F2(
	function (shared, req) {
		return _Utils_Tuple2(
			{privateKey: '', privateKeyError: $elm$core$Maybe$Nothing},
			function () {
				var _v0 = shared.user;
				if (_v0.$ === 'Just') {
					return $author$project$Effect$fromCmd(
						A2($author$project$Request$pushRoute, $author$project$Gen$Route$Home_, req));
				} else {
					return $author$project$Effect$none;
				}
			}());
	});
var $author$project$InteropDefinitions$Login = function (a) {
	return {$: 'Login', a: a};
};
var $author$project$Pages$Login$update = F2(
	function (msg, model) {
		if (msg.$ === 'EnteredPrivateKey') {
			var privateKey = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{privateKey: privateKey, privateKeyError: $elm$core$Maybe$Nothing}),
				$author$project$Effect$none);
		} else {
			return $elm$core$String$isEmpty(model.privateKey) ? _Utils_Tuple2(
				_Utils_update(
					model,
					{
						privateKeyError: $elm$core$Maybe$Just('Private key cannot be empty')
					}),
				$author$project$Effect$none) : _Utils_Tuple2(
				model,
				$author$project$Effect$fromCmd(
					$author$project$InteropPorts$fromElm(
						$author$project$InteropDefinitions$Login(
							{privateKey: model.privateKey}))));
		}
	});
var $author$project$Pages$Login$ClickedLogin = {$: 'ClickedLogin'};
var $author$project$Pages$Login$EnteredPrivateKey = function (a) {
	return {$: 'EnteredPrivateKey', a: a};
};
	...
	return {
		body: _List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('bg-slate-100 h-full flex items-center px-4')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								$elm$html$Html$Attributes$class('w-full max-w-lg mx-auto p-4 bg-white rounded-lg shadow'),
								$elm$html$Html$Events$onSubmit($author$project$Pages$Login$ClickedLogin)
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('flex flex-col mt-4')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Private Key (base 58)'),
										A2(
										$elm$html$Html$input,
										_List_fromArray(
											[
												$elm$html$Html$Attributes$class('border rounded px-2 py-1 mt-1'),
												$elm$html$Html$Attributes$value(model.privateKey),
												$elm$html$Html$Events$onInput($author$project$Pages$Login$EnteredPrivateKey)
											]),
										_List_Nil),
										A2(
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class('w-full rounded mt-6 bg-orange-400 text-white py-2 px-4 hover:bg-orange-300 active:bg-orange-500')
									]),
								_List_fromArray(
									[
										$elm$html$Html$text('Login')
...
var $author$project$Pages$Login$page = F2(
	function (shared, req) {
		return $author$project$Page$advanced(
			{
				init: A2($author$project$Pages$Login$init, shared, req),
				subscriptions: function (_v0) {
					return $elm$core$Platform$Sub$none;
				},
				update: $author$project$Pages$Login$update,
				view: $author$project$Pages$Login$view
			});
	});
...
var $author$project$Shared$init = F2(
	function (_v0, flags) {
		var _v1 = flags.privateKey;
		if (_v1.$ === 'Just') {
			var privateKey = _v1.a;
			return _Utils_Tuple2(
				{
...
var $author$project$Main$init = F3(
	function (flags, url, key) {
		...
		var effect = _v1.b;
		return _Utils_Tuple2(
			{key: key, page: page, shared: shared, url: url},
...
var $author$project$Main$GotToElmPort = function (a) {
	return {$: 'GotToElmPort', a: a};
};
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				A2($elm$core$Platform$Sub$map, $author$project$Main$GotToElmPort, $author$project$InteropPorts$toElm)
			]));
};
var $author$project$Main$NoOp = {$: 'NoOp'};
var $author$project$InteropDefinitions$ScrollTo = function (a) {
	return {$: 'ScrollTo', a: a};
};
var $elm$browser$Browser$Navigation$load = _Browser_load;
var $elm$browser$Browser$Dom$setViewport = _Browser_setViewport;
var $author$project$Pages$Home_$toElmSubscription = function (_v0) {
	return $elm$core$Maybe$Nothing;
};
var $author$project$Pages$Login$toElmSubscription = function (_v0) {
	return $elm$core$Maybe$Nothing;
};
var $author$project$Main$toElmSubscription = F2(
	function (page, toElm) {
		switch (page.$) {
			case 'Redirecting_':
				return $elm$core$Maybe$Nothing;
			case 'Home_':
				return A2(
					$elm$core$Maybe$map,
					$author$project$Gen$Msg$Home_,
					$author$project$Pages$Home_$toElmSubscription(toElm));
			case 'Login':
				return A2(
					$elm$core$Maybe$map,
					$author$project$Gen$Msg$Login,
					$author$project$Pages$Login$toElmSubscription(toElm));
			default:
				return $elm$core$Maybe$Nothing;
		}
	});
var $author$project$Shared$LoggedIn = function (a) {
	return {$: 'LoggedIn', a: a};
};
var $author$project$Shared$LoggedOut = {$: 'LoggedOut'};
var $author$project$Shared$toElmSubscriptions = function (toElm) {
	switch (toElm.$) {
		case 'LoggedIn':
			var privateKey = toElm.a;
			return $elm$core$Maybe$Just(
				$author$project$Shared$LoggedIn(privateKey));
		case 'LoggedOut':
			return $elm$core$Maybe$Just($author$project$Shared$LoggedOut);
		default:
			return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Shared$update = F3(
	function (req, msg, model) {
		if (msg.$ === 'LoggedIn') {
			var privateKey = msg.a.privateKey;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{user: $elm$core$Maybe$Nothing}),
				A2($author$project$Request$pushRoute, $author$project$Gen$Route$Login, req));
		}
	});
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
						...
						function () {
							...
							if (_v3.$ === 'Just') {
								...
								return $author$project$InteropPorts$fromElm(
									$author$project$InteropDefinitions$ScrollTo(
			...
			case 'Page':
				var pageMsg = msg.a;
				var _v6 = A5($author$project$Gen$Pages$update, pageMsg, model.page, model.shared, model.url, model.key);
				var page = _v6.a;
				var effect = _v6.b;
				return _Utils_Tuple2(
					_Utils_update(
									...
									$elm$core$Task$succeed(
										A2(
											...
											A2(
												...
												$author$project$Shared$toElmSubscriptions(toElm))))),
									A2(
									$elm$core$Task$perform,
									$elm$core$Basics$identity,
									$elm$core$Task$succeed(
										A2(
											...
											A2(
												$elm$core$Maybe$map,
												$author$project$Main$Page,
												A2($author$project$Main$toElmSubscription, model.page, toElm)))))
								])));
				} else {
					var error = msg.a.a;
					return _Utils_Tuple2(
						model,
						$author$project$InteropPorts$fromElm(
							$author$project$InteropDefinitions$Alert(
								$elm$json$Json$Decode$errorToString(error))));
				}
		}
	});
...
var $author$project$Main$main = $elm$browser$Browser$application(
	{
		init: F3(
			function (jsonFlags, url, key) {
				var _v0 = $author$project$InteropPorts$decodeFlags(jsonFlags);
				if (_v0.$ === 'Ok') {
					var flags = _v0.a;
					return A2(
						$elm$core$Tuple$mapFirst,
						$author$project$Main$WithValidFlags,
						A3($author$project$Main$init, flags, url, key));
				} else {
					var err = _v0.a;
					return _Utils_Tuple2(
						$author$project$Main$WithInvalidFlags(err),
						$author$project$InteropPorts$fromElm(
							$author$project$InteropDefinitions$Alert(
		...
		subscriptions: function (model) {
			if (model.$ === 'WithValidFlags') {
				var validModel = model.a;
				return $author$project$Main$subscriptions(validModel);
			} else {
				return $elm$core$Platform$Sub$none;
			}
		},
			...
			function (msg, model) {
				if (model.$ === 'WithValidFlags') {
					...
					return A2(
						$elm$core$Tuple$mapFirst,
						$author$project$Main$WithValidFlags,
						A2($author$project$Main$update, msg, validModel));
				} else {
					var err = model.a;
					return _Utils_Tuple2(
						$author$project$Main$WithInvalidFlags(err),
		...
		view: function (model) {
			if (model.$ === 'WithValidFlags') {
				var validModel = model.a;
				return $author$project$Main$view(validModel);
			} else {
				var err = model.a;
				return {
					body: _List_fromArray(
						[
							...
							_List_fromArray(
								[
									$elm$html$Html$text('Invalid flags:')
								])),
							A2(
							$elm$html$Html$p,
							_List_Nil,
